...
const Footer = () => {
    return ( 
        <main className="relative px-[5%] py-10 grid items-center justify-center place-items-center gap-5 bg-dark text-white text-[16px] font-normal">
            <Link href={"/"}>
                <Image src={"/img/logo.png"} width={100} height={100} alt="logo"/>
            </Link>
            <p className="w-[70%] text-center">The cc_gen is an online digital library of credit card design which enable users to view, download and make use of credit cards samples as a resource in their own project.</p>
            <div className="flex items-center justify-center gap-5">
                ...
                <a href="" className="hover:text-orange transition-all delay-150">Dashboard</a>
            </div>
            ...
            <p className="mt-10">Copyright © 2024. CC_Gen. All rights reserved.</p>
        </main>
     );
}

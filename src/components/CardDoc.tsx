    ...
    return (
        <main className="relative top-[60px] sm:top-[70px] px-[5%] py-10 grid grid-cols-1 lg:grid-cols-2 gap-10">
            ...
            <section className="flex flex-col gap-4 text-[14px] md:text-[16px]">
                ...
                <Link href={"/"} className="bg-gradient-to-b from-orange to-yellow hover-orange hover:shadow-2xl hover:shadow-orange transition-all delay-150 w-[200px] px-5 py-3 rounded-md text-white text-center">Try It</Link>
                </div>

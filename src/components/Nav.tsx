    ...
    return (
        <main className="relative flex items-center justify-between gap-4 py-4">
            ...
            <div className="relative flex items-center justify-center gap-4 text-[#0F0F0F]">
                ...
                <div className={`${dropDown ? "absolute" : "hidden"} grid gap-4 top-12 left-0 rounded-2xl bg-[#fff] border border-orange shadow-2xl p-4`}>
                    <div className="flex items-center justify-center gap-2 pb-2 border-b border-b-orange px-2">
                        ...
                        <div className="overflow-hidden">
                            <h1 className="text-[14px] md:text-[16px] font-bold">Annabel Monday</h1>
                            <p className="text-[10px] md:text-[12px]">annabelmonday@gmail.com</p>
                        </div>
                    </div>
                    <div className="grid gap-2 text-[14px] md:text-[16px] font-medium">
                        ...
                        <Link href={"/cardlibrary"} className="flex items-center gap-4 hover:text-orange transition-all delay-150"> <FaCcMastercard className="text-xl text-orange" /> Card Library</Link>
                        <Link href={"/documentation"} className="flex items-center gap-4 hover:text-orange transition-all delay-150"> <IoDocumentTextOutline className="text-xl text-orange" />Documentation</Link>
                        <Link href={"/generate"} className="flex items-center  gap-4 hover:text-orange transition-all delay-150"> <RiAiGenerate className="text-xl text-orange" /> Card Gen</Link>
                        <button className="flex items-center  gap-4 hover:text-orange transition-all delay-150 cursor-pointer"> <AiOutlineLogout className="text-xl text-orange" /> Logout</button>
                    </div>
                </div>

                <div className={`${notification ? "absolute" : "hidden"} grid gap-4 top-12 left-0 rounded-2xl bg-[#fff] border border-orange shadow-2xl p-4`}>
                    <h1 className="text-[14px] md:text-[16px] font-semibold border-b border-b-orange py-2">Notifications</h1>

                    <p className="text-[12px] md:text-[14px] font-normal">No notification at the moment</p>
                </div>
            </div>
        </main>
    );

...
const Sign_In = () => {
    return (
        <main className="relative top-[60px] md:top-[75px] px-[5%] py-10 grid grid-cols-1 md:grid-cols-2 gap-6 items-center justify-between bg-white">
            <section className="grid gap-4 text-[14px] md:text-[16px] font-normal text-dark text-center md:text-left">
                <h1 className="text-[36px] sm:text-[38px] md:text-[48px] font-bold">Sign in to continue</h1>
                <p className="w-full lg:w-[65%] leading-relaxed tracking-wide">Welcome back to Card Cafe credit card generator. Please sign in to continue from where you left off.</p>
            </section>
            ...
            <section className="grid place-items-center mt-6 md:mt-0">
                <form action="" className="w-full sm:w-[95%] xl:w-[70%] grid gap-6 text-[14px] md:text-[16px] text-dark shadow shadow-yellow rounded-xl py-8 px-10">
                    <label htmlFor="email">Email Address
                        <input name="email" id="email" type="text" placeholder="user@gmail.com" className="input" />
                    </label>
                    <label htmlFor="password">Password
                        <input name="password" id="password" type="text" placeholder="Enter Password" className="input" />
                    </label>

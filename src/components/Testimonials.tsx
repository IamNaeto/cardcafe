    ...
    return (
        <main className="relative px-[5%] py-16 grid grid-cols-1 md:grid-cols-2 gap-5 items-center justify-between bg-white text-[14px] md:text-[16px] text-dark">
            <section className="grid gap-4 text-justify order-2 md:order-1">
                <div className="bg-[#E7F5F6] p-4 rounded-xl max-w-full md:max-w-[500px] flex items-center justify-center gap-4 ml-0 md:ml-[9%]">
                ...
                <div className="bg-[#FEF4E8] p-4 rounded-xl max-w-full md:max-w-[500px] flex items-center justify-center gap-4">
                ...
                <div className="bg-[#F8EBF3] p-4 rounded-xl max-w-full md:max-w-[500px] flex items-center justify-center gap-4 ml-0 md:ml-[15%]">
                    <Image src={"/img/user-3.png"} width={70} height={70} alt="user1" loading="lazy" />
                    <p>Card cafe is the best. I love the card designs, the navigation is simple and the platform is easy to use.</p>
                </div>
            </section>

            <section className="grid gap-4 font-normal mt-5 md:mt-0 order-1 md:order-2">

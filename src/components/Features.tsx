...
const Features = () => {
    return ( 
        <main className="relative px-[5%] py-16 grid grid-cols-2 items-center justify-between bg-gradient-to-r from-[#FFF7F2] to-[#fff5ee]">
            <section className="grid gap-4 text-[16px] text-dark font-normal">
                <h1 className="text-[46px] font-extrabold">Features</h1>
                <ul className="leading-relaxed tracking-wide list-disc">
